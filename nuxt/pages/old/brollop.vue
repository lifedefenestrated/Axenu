<template>
  <div class="projects">
    <NavBar title="Dreamwedding with great weddings"></NavBar>

    <div class="card">
      <div class="card-body">
        <div class="card-column flex-1">
      ...
      <div class="card-body">
        <div class="card-row">
          <div class="card-column flex-3">
            ...
            <h3>Great Weddings</h3>
          </div>
          <div class="card-column">
            <div class="flex-1 img-container">
              <img
                src="../../assets/images/dreamwedding/Icon.png"
                alt="Image of founer"
    ...
    <div class="card">
      <div class="card-body">
        <div class="card-column">
          <h3>Dreamwedding with Great-Weddings</h3>
          <div class="card-row center">
            ...
            <div class="img-container ios-screenshot">
              <img
                class="screenshot"
                src="../../assets/images/dreamwedding/screenshot4.jpg"
                alt="Image of product"
              />
            </div>
          </div>
          ...
          <div style="display: flex; flex-direction: row;">
            <DownloadApp
              type="apple"
              link="https://apps.apple.com/us/app/dreamwedding-great-weddings/id1353935336"
            ></DownloadApp>
            <DownloadApp
              type="google"
              link="https://play.google.com/store/apps/details?id=com.axenu.weddingplanner&hl=en"
            ></DownloadApp>
          </div>
        </div>
      </div>
...
export default {
  ...
  computed: {
    product() {
      return this.$store.state.products[this.$route.params.key]
    }
  },
  mounted() {
    // this.getBlogPosts();
